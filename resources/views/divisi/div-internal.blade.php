...
<main>
        ...
        <div class="hero-content flex-col lg:flex-row px-5 sm:px-16 2xl:px-0">
            ...
            <div class=" text-neutral-content px-3 max-w-full text-center lg:text-left">
                ...
                <ol class="list-decimal list-inside py-3 sm:text-lg">
                    ...
                    <li>Memfasilitasi aktivitas olahraga untuk meningkatkan kesehatan warga Sistem Informasi.</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-wrap justify-evenly pb-6">
        <div class="inline-block m-2 card lg:w-72 max-w-xs bg-base-100 shadow-xl text-center sm:hover:-translate-y-2 duration-100">
            <figure><img src="./img/pengurus/internal/koor.png" alt="kadiv internal" class="max-h-min" loading="lazy"></figure>
            <div class="card-body">
                <h2 class="card-title justify-center">Al-Amin</h2>
                <p>Ketua Divisi</p>
            </div>
        </div>
        <div class="inline-block m-2 card lg:w-72 max-w-xs bg-base-100 shadow-xl text-center sm:hover:-translate-y-2 duration-100">
            <figure><img src="./img/pengurus/internal/sek.png" alt="sekbend internal" class="max-h-min" loading="lazy"></figure>
            <div class="card-body">
                <h2 class="card-title justify-center">Ghina Anfasha Nurhadi</h2>
    ...
    <!-- <section class="text-center py-16">
        ...
        <div class="flex flex-col sm:flex-row flex-wrap justify-evenly text-neutral-content">
            <ol class="list-none text-lg sm:text-xl">
                <li>Ruchil Amelinda</li>
            </ol>
            <ol class="list-none text-lg sm:text-xl">
                <li>Angeli Putri Rahmadhani</li>
            </ol>
            <ol class="list-none text-lg sm:text-xl">
                <li>Sistri Mahira</li>
            </ol>
