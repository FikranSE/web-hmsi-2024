    ...
    <div class="hero min-h-screen">
        <div class="hero-content flex-col lg:flex-row px-5 sm:px-16 2xl:px-0">
            <div class="flex justify-center">
                <img src="./img/pengurus/eksternal/eksternal.jpg" alt="divisi eksternal" class="max-w-l rounded-lg shadow-2xl sm:hover:-translate-y-2 duration-100" loading="lazy" />
            </div>
