            ...
            <li class="pt-5 font-bold text-xl">Sejarah Berdirinya Himpunan Mahasiswa Sistem Informasi</li>
              ...
              <ol class="list-decimal list-outside pl-4">
                <li>September 2010</li>
                  <p>Mahasiswa Sistem Informasi masuk ke Fakultas Teknik sebagai salah satu jurusan di Teknik.</p>
                <li>Mei 2011</li>
                  <p>Mahasiswa Sistem Informasi mengadakan pemilihan calon pengurus Himpunan Mahasiswa Sistem Informasi dan membahas mengenai AD/ART</p>
                <li>Juni 2011</li>
                  <p>Mahasiswa Sistem Informasi mengadakan MUBES I serta pengesahan AD/ART dan kepengurusan Himpunan Mahasiswa Sistem Informasi</p>
              </ol>
            <li class="pt-5 font-bold text-xl">Visi dan Misi Himpunan Mahasiswa Sistem Informasi</li>
              <ul class="list-disc list-outside pl-4">
                <li>Visi</li>
                  <ol class="">
                    <li>a.	Meningkatkan mutu dan kualitas anggota sesuai dengan bidangnya</li>
                    <li>b.  Meningkatkan rasa persaudaraan diantara anggotanya</li>
                    <li>c.	Membantu pelaksanaan Tridarma Perguruan Tinggi sesuai dengan bidangnya</li>
                  </ol>
                <li>Misi</li>
                  <ol>
                    <li>a.  Mengakomodasikan, mengkoordinasikan dan mewujudkan segenap aspirasi mahasiswa Sistem Informasi;</li>
